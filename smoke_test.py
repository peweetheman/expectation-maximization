...
DATA_DIR = r'C:\Users\Patrick\Documents\Spring_2019\CSC_246\mixture_of_gaussians' #TODO: change this to wherever you put the data if working on a different machine
SIGFIG_NUM = 5
