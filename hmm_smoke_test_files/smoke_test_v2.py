...
DATA_DIR = r'C:\Users\Patrick\Documents\Spring_2019\CSC_246\EM_HMM' #TODO: change this to wherever you put the data if working on a different machine
SIGFIG_NUM = 5
...
def get_output(filename):
    import subprocess
    cmd = None
    if filename.endswith('_hmm_gaussian.py'): #add ./to command!
